...
describe("utils.cssLoaders", () => {
    test("0", () => {
        let callFunction = () => {
            utils.cssLoaders({ sourceMap: true, usePostCSS: false, extract: "Edmond" })
        }
    ...
    test("2", () => {
        let callFunction = () => {
            utils.cssLoaders({ sourceMap: false, usePostCSS: true, extract: "Jean-Philippe" })
        }
    ...
    test("4", () => {
        let callFunction = () => {
            utils.cssLoaders({ sourceMap: false, usePostCSS: true, extract: "Anas" })
        }
